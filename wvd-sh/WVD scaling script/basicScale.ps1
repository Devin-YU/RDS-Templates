...
function Write-Log {
    param(
        [int]$level
        , [string]$Message
        , [ValidateSet("Info", "InfoHA", "Warning", "Error")] [string]$severity = 'Info'
...
Write-Log 3 "ActivityId: $ActivityId - Please use this guid to query this execution on $ScalingLogTableName table." "Info"
...
Write-Verbose -Verbose "OwnerToken returned: $($OwnerToken.GetPropertiesAsHashTable() | Out-String)"
